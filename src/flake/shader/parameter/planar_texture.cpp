...
void
flake::shader::parameter::planar_texture::set(
...
void
flake::shader::parameter::planar_texture::activate(
...
void
flake::shader::parameter::planar_texture::deactivate()
{
	FCPPT_ASSERT_PRE(
		optional_render_context_);
...
flake::shader::parameter::planar_texture::loaded_texture()
{
	return
		*loaded_texture_;
}
...
flake::shader::parameter::planar_texture::stage() const
{
	FCPPT_ASSERT_PRE(
		scoped_texture_);
	return
