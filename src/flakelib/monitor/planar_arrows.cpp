...
flakelib::monitor::planar_arrows::planar_arrows(
...
fcppt::string const
flakelib::monitor::planar_arrows::name() const
{
	return name_;
}

void
flakelib::monitor::planar_arrows::render(
...
void
flakelib::monitor::planar_arrows::update()
{
	if(sprite_)
	{
		sprite_->pos(
...
flakelib::monitor::planar_arrows::widget()
{
	return box_parent_;
}
