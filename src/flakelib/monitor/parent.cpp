...
void
flakelib::monitor::parent::to_texture(
	flakelib::planar_object const &_planar_object,
...
void
flakelib::monitor::parent::image_to_vb(
...
void
flakelib::monitor::parent::planar_buffer_to_vb(
...
void
flakelib::monitor::parent::image_to_image(
...
void
flakelib::monitor::parent::planar_buffer_to_image(
