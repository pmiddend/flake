...
#include <flakelib/monitor/dummy_sprite/parameters.hpp>
...
flakelib::monitor::texture::texture(
...
void
flakelib::monitor::texture::render(
...
void
flakelib::monitor::texture::update()
{
...
flakelib::monitor::texture::widget()
{
	return box_parent_;
}

rucksack::widget::base const &
flakelib::monitor::texture::widget() const
{
	return box_parent_;
}

rucksack::widget::base &
flakelib::monitor::texture::content_widget()
{
	return sprite_box_;
}

rucksack::widget::base const &
flakelib::monitor::texture::content_widget() const
{
	return sprite_box_;
}

fcppt::string const
flakelib::monitor::texture::name() const
{
	return name_;
}
