...
flakelib::planar::monitor::planar_arrows::planar_arrows(
...
flakelib::planar::monitor::planar_arrows::cl_buffer()
{
	return cl_vb_;
}

flakelib::planar::monitor::scalar
flakelib::planar::monitor::planar_arrows::arrow_scale() const
{
	return arrow_scale_;
}

flakelib::planar::monitor::scalar
flakelib::planar::monitor::planar_arrows::grid_scale() const
{
	return grid_scale_;
}

fcppt::string const
flakelib::planar::monitor::planar_arrows::name() const
{
	return name_;
}

void
flakelib::planar::monitor::planar_arrows::render(
...
void
flakelib::planar::monitor::planar_arrows::update()
{
	if(sprite_)
	{
		sprite_->pos(
...
flakelib::planar::monitor::planar_arrows::widget()
{
	return box_parent_;
}
