...
flakelib::planar::laplace_solver::multigrid::multigrid(
...
void
flakelib::planar::laplace_solver::multigrid::solve(
	...
	planar::laplace_solver::boundary const &_boundary)
{
	...
	this->laplacian_residual(
		_rhs,
		planar::laplace_solver::from(
			first_smoothing.value()),
		planar::laplace_solver::to(
			p0.value()),
		_boundary);
...
flakelib::planar::laplace_solver::multigrid::additional_scalar_data() const
{
...
void
flakelib::planar::laplace_solver::multigrid::laplacian_residual(
	planar::laplace_solver::rhs const &_rhs,
	planar::laplace_solver::from const &_from,
	planar::laplace_solver::to const &_to,
	planar::laplace_solver::boundary const &_boundary)
{
	FCPPT_ASSERT_PRE(
...
// to = small
void
flakelib::planar::laplace_solver::multigrid::downsample(
	planar::laplace_solver::from const &_from,
	planar::laplace_solver::to const &_to)
{
	FCPPT_ASSERT_PRE(
...
// to = big
void
flakelib::planar::laplace_solver::multigrid::upsample(
	planar::laplace_solver::from const &_from,
	planar::laplace_solver::to const &_to)
{
	FCPPT_ASSERT_PRE(
...
void
flakelib::planar::laplace_solver::multigrid::add(
	planar::laplace_solver::from const &_from0,
	planar::laplace_solver::from const &_from1,
	planar::laplace_solver::to const &_to)
{
	FCPPT_ASSERT_PRE(
...
void
flakelib::planar::laplace_solver::multigrid::copy_to_planar_data(
	...
	fcppt::string const &_description)
{
	...
	additional_scalar_data_.push_back(
		flakelib::planar::additional_scalar_data::value_type(
