...
flakelib::planar::laplace_tester::laplace_tester(
	planar::laplace_solver::base &_solver,
...
void
flakelib::planar::laplace_tester::render(
...
void
flakelib::planar::laplace_tester::update()
{
	...
	for(
		flakelib::planar::additional_scalar_data::const_iterator it =
			solver_.additional_scalar_data().begin();
		it != solver_.additional_scalar_data().end();
		++it)
	{
