#ifndef FLAKELIB_PLANAR_MONITOR_PLANAR_ARROWS_HPP_INCLUDED
#define FLAKELIB_PLANAR_MONITOR_PLANAR_ARROWS_HPP_INCLUDED
...
#include <flakelib/planar/monitor/dummy_sprite/object.hpp>
