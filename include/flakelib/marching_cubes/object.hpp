...
private:
	...
	flakelib::marching_cubes::grid_size const grid_size_;
	flakelib::cl::uint4 const grid_size_log2_;
	flakelib::marching_cubes::grid_size_mask const grid_size_mask_;
	flakelib::marching_cubes::grid_size_shift const grid_size_shift_;
