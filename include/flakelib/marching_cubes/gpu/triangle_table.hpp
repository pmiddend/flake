#ifndef FLAKELIB_MARCHING_CUBES_GPU_TRIANGLE_TABLE_HPP_INCLUDED
#define FLAKELIB_MARCHING_CUBES_GPU_TRIANGLE_TABLE_HPP_INCLUDED
...
#define X 255
unsigned char triangle_table[256][16] = {
